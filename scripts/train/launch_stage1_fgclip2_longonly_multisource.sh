...
if (( MAX_CAPTION_TOKENS > 0 )); then
  DEFAULT_TRAIN_LOG_DIR="$ROOT/output/stage1_from_siglip2_longonly_302M_filtered_cap${MAX_CAPTION_TOKENS}"
  DEFAULT_LAUNCH_LOG_DIR="$ROOT/output/stage1_fgclip2_longonly_multisource_launcher_filtered_cap${MAX_CAPTION_TOKENS}"
else
  DEFAULT_TRAIN_LOG_DIR="$ROOT/output/stage1_from_siglip2_longonly_302M"
  DEFAULT_LAUNCH_LOG_DIR="$ROOT/output/stage1_fgclip2_longonly_multisource_launcher"
fi
TRAIN_LOG_DIR="${TRAIN_LOG_DIR:-$DEFAULT_TRAIN_LOG_DIR}"
LAUNCH_LOG_DIR="${LAUNCH_LOG_DIR:-$DEFAULT_LAUNCH_LOG_DIR}"
...
export BASE_SEQ_LENGTH="$BASE_SEQ_LENGTH"
...
export MAX_CAPTION_TOKENS="$MAX_CAPTION_TOKENS"
