...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-$ROOT/scripts/train/stage1_fgclip2_longonly_multisource_len400.sh}"
...
MAX_SEQ_LENGTH="${MAX_SEQ_LENGTH:-400}"
...
MAX_CAPTION_TOKENS="${MAX_CAPTION_TOKENS:-0}"
...
TRAIN_LOG_DIR="${TRAIN_LOG_DIR:-$ROOT/output/stage1_from_siglip2_longonly_302M_len400}"
LAUNCH_LOG_DIR="${LAUNCH_LOG_DIR:-$ROOT/output/stage1_fgclip2_longonly_multisource_len400_launcher}"
