...
LOG_DIR="${LOG_DIR:-$ROOT/output/stage1_from_siglip2_longonly_302M_len400}"
...
echo "USE_LONG_CAPTION=$USE_LONG_CAPTION USE_SHORT_CAPTION=$USE_SHORT_CAPTION"
